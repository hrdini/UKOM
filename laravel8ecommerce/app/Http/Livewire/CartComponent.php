...
class CartComponent extends Component
{
    ...
    public function increaseQuantity($rowId)
    {
        ...
        public function calculateDiscounts()
        {
            if(session()->has('coupon'))
            {
                ...
                $this->taxAfterDiscount = ($this->subtotalAfterDiscount + config('cart.tax'))/50;
        ...
        public function render()
    {
        ...
        return view('livewire.cart-component', ['popular_products'=>$popular_products,'totalcharge'=>$totalcharge,'shippingcharge'=>$shippingcharge])->layout('layouts.base');
    }
}
