                                ...
                                <ul class="sclist">
                                                @foreach ($category->subCategories as $scategory)
                                                    <li><i class="fa fa-caret-right"></i> {{$scategory->name}} 
                                                        ...
                                                        <a href="#" class="slink" wire:click.prevent="deleteSubcategory({{$scategory->id}})" onclick="confirm('You want to delete this subcategory?') || event.stopImediatePropagation()"> 
