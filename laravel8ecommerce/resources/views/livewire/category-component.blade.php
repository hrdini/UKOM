    ...
    <div class="container">
        ...
        <div class="wrap-breadcrumb">
            <ul>
                ...
                <li class="item-link"><span>Menu Categories</span></li>
                ...
                <h2 class="widget-title">Merchandise</h2>
                    <div class="widget-content">
                        <ul class="list-style vertical-list list-limited" data-show="6">
                            <li class="list-item"><a class="filter-link " href="#">Tumbler</a></li>
                            ...
                            <li class="list-item"><a class="filter-link " href="#">Waterbottle</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">Cold Cup</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">Reusable Straw</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">Waterbottle</a></li>
                            <li class="list-item default-hiden"><a class="filter-link " href="#">Tumbler</a></li>
