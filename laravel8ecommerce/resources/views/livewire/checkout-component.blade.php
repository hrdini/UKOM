        ...
        <div class="main-content-area">
            ...
            <div class="summary summary-checkout">
                <div class="summary-item payment-method">
                    ...
                    <p class="row-in-form">
                        <label for="exp-mont">Expiry Month:</label>
                    ...
                    <div class="choose-payment-methods">
                        ...
                        <label class="payment-method">
                            ...
                            <span class="payment-desc">There are many variations of passages available</span>
                        </label>
                        <label class="payment-method">
                    ...
                    @if (Session::has('checkout'))
                            <p class="summary-info grand-total"><span>Grand Total</span> <span class="grand-total-price">Rp{{number_format($totalcharge,3)}}</span></p>
                    @endif
                ...
                <div class="summary-item shipping-method">
                        ...
                        <p class="row-in-form">Shipping charge is 5% of Menu price</p>
                        <p class="row-in-form">Rp{{number_format($shippingcharge, 3)}}</p>
                    </div>
            </div>
        </div>
        </form>
