<main id="main">
    <div class="container">
        ...
        <div class="wrap-banner style-twin-default">
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="{{ asset('assets/images/62882.jpg') }}" alt="" width="580" height="190"></figure>
                </a>
            </div>
            <div class="banner-item">
                <a href="#" class="link-banner banner-effect-1">
                    <figure><img src="{{ asset('assets/images/maxresdefault.jpg') }}" alt="" width="580" height="190"></figure>
                </a>
            </div>
        </div>
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            <h3 class="title-box">On Promo</h3>
        ...
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box">Latest Menu</h3>
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/starbucks-banner.jpg') }}" width="1170" height="240" alt=""></figure>
                </a>
            </div>
        ...
        <!--Product Categories-->
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box">Menu Categories</h3>
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{ asset('assets/images/Untitled.png') }}" width="1170" height="240" alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
                <div class="wrap-product-tab tab-style-1">
